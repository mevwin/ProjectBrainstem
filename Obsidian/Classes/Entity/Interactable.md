...
4) the isActive variable can be set through entity states (i.e. ButtonPressedState handles logic for when the button stops beinng pressed). When isActive is updated, the DetectActivation function should be called to sennd out the event
